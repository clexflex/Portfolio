  ...
  return (
    <section className="max-container">
      ...
      <div className="py-16">
            ...
            <div className="mt-5 flex flex-col gap-3 text-slate-500">
            <p> Internship experience fueled my passion for practical problem-solving and collaboration. From data analysis to version control, I delved into diverse tasks with enthusiasm, eager to make meaningful contributions and pave the way for future endeavors in the tech realm. Here's the rundown:</p>
            </div>
